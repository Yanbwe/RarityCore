...
public class IdCacheManager {
    ...
    private static volatile Cache<Identifier, Integer> idCache;
     ...
     */
    public static Integer getCachedRarity(Identifier itemId) {
        if (itemId == null) {
            return null;
        }
     ...
     * @param rarity 稀有度等级
     */
    public static void cacheRarity(Identifier itemId, Integer rarity) {
     ...
     */
    public static void updateRarity(Identifier itemId, Integer rarity) {
        if (itemId == null) {
            return;
        }
        if (rarity != null) {
    ...
    private static Cache<Identifier, Integer> createCacheForReload() {
        int actualCacheSize = config.getActualMaxCacheSize();
