...
/**
 * NBT匹配规则定义
 * 描述了特定物品在满足某些NBT条件时应该具有的稀有度
 */
public class NbtMatchRule {
    private final ResourceLocation itemId;
    private final List<NbtCondition> conditions;
    ...
    public boolean equals(Object o) {
        ...
        NbtMatchRule that = (NbtMatchRule) o;
    ...
    public String toString() {
        return String.format("NbtMatchRule{itemId=%s, conditions=%d, priority=%d, rarity=%d, enabled=%s, fuzzyMatch=%s}", 
    ...
    public static class Builder {
        ...
        private List<NbtCondition> conditions;
        ...
        public Builder conditions(List<NbtCondition> conditions) {
        ...
        public NbtMatchRule build() {
            return new NbtMatchRule(itemId, conditions, priority, rarity, enabled, fuzzyMatch, description);
        }
    }
