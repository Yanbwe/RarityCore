...
public class SimpleConfigValidator {
     ...
     */
    private static NbtCondition parseCondition(JsonObject conditionObj) {
     ...
     * 解析等值条件
     */
    private static NbtCondition parseEqualsCondition(JsonObject conditionObj,
     ...
     * 解析范围条件
     */
    private static NbtCondition parseRangeCondition(JsonObject conditionObj,
                                                    String path, String description) {
     ...
     * 解析包含条件
     */
    private static NbtCondition parseContainsCondition(JsonObject conditionObj,
                                                       String path, String description) {
